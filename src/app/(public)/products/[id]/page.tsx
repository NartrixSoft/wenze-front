...
export default function ProductDetailPage() {
  ...
  const handleContactSeller = async () => {
    try {
      ...
      setError("Erreur lors de la gestion de la conversation", error);
    }
  };
  ...
  return (
    <main className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6 bg-white shadow-md p-4 rounded-xl">
        <Image
          src={product.product_image || "/default/default.png"}
          alt={product.name}
          width={600}
          height={400}
      ...
      <div className="bg-orange-50 p-4 rounded-xl shadow-md">
        ...
        <div className="flex items-center gap-4">
          <Image
            src={product.owner.profile_picture || '/default/user.png'}
